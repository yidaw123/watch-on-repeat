...
let mockInput = { value: '' };
let ci = new CascadingTimeInput(mockInput, true);
ci.setValue(null);
console.log('With null: ' + mockInput.value);
ci.setValue('');
console.log('With empty string: ' + mockInput.value);
ci.setValue(0);
console.log('With 0: ' + mockInput.value);
